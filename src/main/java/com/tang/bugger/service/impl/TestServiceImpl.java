...
public class TestServiceImpl {
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(TestServiceImpl.class);
    ...
    public void process() {
        try {
            ...
            LOGGER.info("11111111" + orderExceptionInfo);
            new Thread(() -> {
                self.update();
            }).start();
            try {
            ...
            LOGGER.info("我要查询啦，那货提交了吗？？？？" + System.currentTimeMillis());
            ...
            LOGGER.info("2222" + orderExceptionInfo2);
    ...
    public void update() {
        ...
        LOGGER.info("我要提交啦！！！！" + System.currentTimeMillis());
    }
